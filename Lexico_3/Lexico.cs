...
/*
Requerimientos: 
        1. Colocar en el Log fecha y hora de análisis
        2. Indentar matriz de Transicion
        3. Agregar el operador de flujo de salida >>
        4. Agregar el operador de flujo de entrada <<
*/
namespace Lexico_3
{
   ...
   //WS,EF,EL, L, D, ., E, +, -, =, :, ;, &, |, !, >, <, *, %, ", ', ?,La, /
        ...
        public Lexico()
        {
            archivo = new StreamReader("D:\\USER\\C Sharp\\Archivos\\Prueba.cs");
            log = new StreamWriter("D:\\USER\\C Sharp\\Archivos\\Prueba.log");
            log.AutoFlush = true;
